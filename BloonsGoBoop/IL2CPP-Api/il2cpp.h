...
typedef struct Il2cppRuntime {
	static void* GetIL2CPPModule()
	{
		auto mod = LoadLibrary(L"GameAssembly.dll");
		if (mod != NULL) return mod;
	}
	static Il2CppImage* il2cpp_assembly_get_image(const char* name)
	{
		auto il2cpp_assembly_get_image = (il2cpp_assembly_get_image_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_assembly_get_image");
		auto assembly = (il2cpp_domain_assembly_open_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_domain_assembly_open");
	...
	{
		auto il2cpp_class_from_name = (il2cpp_class_from_name_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_class_from_name");
	...
	{
		auto il2cpp_class_from_index = (il2cpp_class_from_index_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_image_get_class");

		return il2cpp_class_from_index(assembly, index);
	}
	static uint32_t il2cpp_method_get_token(Il2CppMethod* method)
	{
		auto il2cpp_method_get_token = (il2cpp_method_get_token_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_method_get_token");
	...
	{
		auto il2cpp_class_get_method_from_name = (il2cpp_class_get_method_from_name_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_class_get_method_from_name");
	...
	{
		auto il2cpp_class_get_fields = (il2cpp_class_get_fields_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_class_get_fields");
	...
	{
		auto il2cpp_class_get_methods = (il2cpp_class_get_methods_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_class_get_methods");
	...
	{
		auto il2cpp_field_from_name = (il2cpp_class_get_field_from_name_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_class_get_field_from_name");
	...
	static Il2CppMethod* il2cpp_property_get_get_method(Il2CppClass* klass, const char* name) {
		il2cpp_class_get_property_from_name_t il2cpp_string_chars = (il2cpp_class_get_property_from_name_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_class_get_property_from_name");
		il2cpp_property_get_get_method_t il2cpp_string_chars_2 = (il2cpp_property_get_get_method_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_property_get_get_method");
	...
	{
		auto il2cpp_field_get_value = (il2cpp_field_get_value_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_field_get_value");
	...
	{
		auto il2cpp_field_set_value = (il2cpp_field_set_value_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_field_set_value");

		return il2cpp_field_set_value(object, field, value);
	}
	static void il2cpp_field_static_get_value(Il2CppField* field, void* value)
	{
		auto il2cpp_field_static_get_value = (il2cpp_field_static_get_value_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_field_static_get_value");

		return il2cpp_field_static_get_value(field, value);
	}
	static void il2cpp_field_static_set_value(Il2CppField* field, void* value)
	{
		auto il2cpp_field_static_set_value = (il2cpp_field_static_set_value_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_field_static_set_value");
	...
	{
		auto il2cpp_runtime_invoke = (il2cpp_runtime_invoke_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_runtime_invoke");

		return il2cpp_runtime_invoke(method, obj, params, NULL);
	}
	static Il2CppArray* il2cpp_array_new(Il2CppClass* klass, uint32_t length)
	{
		auto il2cpp_array_new = (il2cpp_array_new_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_array_new");

		return il2cpp_array_new(klass, length);
	}
	static Il2CppString* il2cpp_string_new(const char* str)
	{
		auto il2cpp_string = (il2cpp_string_new_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_string_new");

		return il2cpp_string(str);
	}
	static const char16_t* il2cpp_string_chars(Il2CppString* string)
	{
		auto il2cpp_string_chars = (il2cpp_string_chars_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_string_chars");

		return il2cpp_string_chars(string);
	}
	static uint32_t il2cpp_object_get_size(Il2CppObject* object)
	{
		auto il2cpp_object_get_size = (il2cpp_object_get_size_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_object_get_size");

		return il2cpp_object_get_size(object);
	}
	static Il2CppObject* il2cpp_object_new(Il2CppClass *klass) {
		auto il2cpp_object_new = (il2cpp_object_new_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_object_get_size");

		return il2cpp_object_new(klass);
	}
	static uint32_t il2cpp_array_get_byte_length(Il2CppArray* array)
	{
		auto il2cpp_array_get_byte_length = (il2cpp_array_get_byte_length_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_array_get_byte_length");

		return il2cpp_array_get_byte_length(array);
	}
	static uint32_t il2cpp_array_get_length(Il2CppArray* array)
	{
		auto il2cpp_array_get_length = (il2cpp_array_get_length_t)GetProcAddress((HMODULE)GetIL2CPPModule(), "il2cpp_array_length");
